module Uniciclo (
    ...
    logic [31:0] PCNext;
	 ...
	 assign Instrucao = Instr;
	 assign A         = ReadData1;

    assign PCmais4  = PC + 32'd4;
    assign PCBranch = PC + SaidaImediato;
    assign PCJalr   = (ReadData1 + SaidaImediato) & 32'hFFFF_FFFE;
...
always @(*) begin
    case (OrigPC)
        ...
        2'b01: PCNext = PCBranch;                        // jal
        2'b10: PCNext = PCJalr;                          // jalr
        2'b11: PCNext = BranchZero ? PCBranch : PCmais4; // beq
